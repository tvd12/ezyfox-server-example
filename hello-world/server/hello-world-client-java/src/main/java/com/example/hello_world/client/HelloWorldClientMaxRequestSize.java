...
public class HelloWorldClientMaxRequestSize {
    ...
    public HelloWorldClientMaxRequestSize() {
    ...
    public static void main(String[] args) throws Exception {
        ...
        HelloWorldClientMaxRequestSize client = new HelloWorldClientMaxRequestSize();
